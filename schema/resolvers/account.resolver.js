// resolver funciona como um service, chama o repository para criar
// no caso dessa aplicação, podemos chaamr o service direto, ou criar um resolve (este arquivo)
